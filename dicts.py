...
users_sessions_cols = ['view_search_results', 'wishlist_content_update',
       'similar_listings', 'change_trip_characteristics', 'p3',
       'header_userpic', 'contact_host', 'message_post_x', '-unknown-_x',
       ...
       'deactivate_user_account', 'click', 'data', 'view', 'submit',
       'message_post_y', '-unknown-_y', 'booking_request', 'partner_callback',
       'booking_response', 'modify', 'dac_year', 'dac_month', 'dac_day',
       'dac_week', 'dac_yearweek', 'dac_yearmonthday', 'dac_yearmonthweek',
       'tfa_week', 'tfa_yearweek', 'tfa_yearmonthday', 'tfa_yearmonthweek',
       'lag', 'NAs_profile', 'age_NAs', 'gender_NAs', 
       'genderFEMALE', 'genderMALE', 'genderNA',
       'genderOTHER', 'signup_methodbasic', 'signup_methodfacebook',
       'signup_methodgoogle', 'signup_methodweibo', 'signup_flow',
       'language-unknown-', 'languageca', 'languagecs', 'languageda',
       'languagede', 'languageel', 'languageen', 'languagees',
       'languagefi', 'languagefr', 'languagehr', 'languagehu',
       'languageid', 'languageis', 'languageit', 'languageja',
       'languageko', 'languagenl', 'languageno', 'languagepl',
       'languagept', 'languageru', 'languagesv', 'languageth',
       'languagetr', 'languagezh', 'affiliate_channelapi',
       'affiliate_channelcontent', 'affiliate_channeldirect',
       'affiliate_channelother', 'affiliate_channelremarketing',
       'affiliate_channelsem-brand', 'affiliate_channelsem-non-brand',
       'affiliate_channelseo', 'affiliate_providerbaidu',
       'affiliate_providerbing', 'affiliate_providercraigslist',
       'affiliate_providerdaum', 'affiliate_providerdirect',
       'affiliate_provideremail-marketing', 'affiliate_providerfacebook',
       'affiliate_providerfacebook-open-graph', 'affiliate_providergoogle',
       'affiliate_providergsp', 'affiliate_providermeetup',
       'affiliate_providernaver', 'affiliate_providerother',
       'affiliate_providerpadmapper', 'affiliate_providervast',
       'affiliate_providerwayn', 'affiliate_provideryahoo',
       'affiliate_provideryandex', 'first_affiliate_trackedlinked',
       'first_affiliate_trackedlocal ops',
       'first_affiliate_trackedmarketing', 'first_affiliate_trackedNA',
       'first_affiliate_trackedomg', 'first_affiliate_trackedproduct',
       'first_affiliate_trackedtracked-other',
       'first_affiliate_trackeduntracked', 'signup_appAndroid',
       'signup_appiOS', 'signup_appMoweb', 'signup_appWeb',
       'first_device_typeAndroid Phone', 'first_device_typeAndroid Tablet',
       'first_device_typeDesktop (Other)', 'first_device_typeiPad',
       'first_device_typeiPhone', 'first_device_typeMac Desktop',
       'first_device_typeOther/Unknown',
       'first_device_typeSmartPhone (Other)',
       'first_device_typeWindows Desktop', 'first_browser-unknown-',
       'first_browserAndroid Browser', 'first_browserAOL Explorer',
       'first_browserApple Mail', 'first_browserArora',
       'first_browserAvant Browser', 'first_browserBlackBerry Browser',
       'first_browserCamino', 'first_browserChrome',
       'first_browserChrome Mobile', 'first_browserChromium',
       'first_browserCometBird', 'first_browserComodo Dragon',
       'first_browserConkeror', 'first_browserCoolNovo',
       'first_browserCrazy Browser', 'first_browserEpic',
       'first_browserFirefox', 'first_browserFlock',
       'first_browserGoogle Earth', 'first_browserGooglebot',
       'first_browserIBrowse', 'first_browserIceDragon',
       'first_browserIceWeasel', 'first_browserIE',
       'first_browserIE Mobile', 'first_browserIron',
       'first_browserKindle Browser', 'first_browserMaxthon',
       'first_browserMobile Firefox', 'first_browserMobile Safari',
       'first_browserMozilla', 'first_browserNetNewsWire',
       'first_browserNintendo Browser', 'first_browserOmniWeb',
       'first_browserOpera', 'first_browserOpera Mini',
       'first_browserOpera Mobile', 'first_browserOutlook 2007',
       'first_browserPale Moon', 'first_browserPalm Pre web browser',
       'first_browserPS Vita browser', 'first_browserRockMelt',
       'first_browserSafari', 'first_browserSeaMonkey',
       'first_browserSilk', 'first_browserSiteKiosk',
       'first_browserSlimBrowser', 'first_browserSogou Explorer',
       'first_browserStainless', 'first_browserTenFourFox',
       'first_browserTheWorld Browser', 'first_browserUC Browser',
       'first_browserwOSBrowser', 'first_browserYandex.Browser',
       'dac_yearmonth201001', 'dac_yearmonth201002', 'dac_yearmonth201003',
       'dac_yearmonth201004', 'dac_yearmonth201005', 'dac_yearmonth201006',
       'dac_yearmonth201007', 'dac_yearmonth201008', 'dac_yearmonth201009',
       'dac_yearmonth201010', 'dac_yearmonth201011', 'dac_yearmonth201012',
       'dac_yearmonth201101', 'dac_yearmonth201102', 'dac_yearmonth201103',
       'dac_yearmonth201104', 'dac_yearmonth201105', 'dac_yearmonth201106',
       'dac_yearmonth201107', 'dac_yearmonth201108', 'dac_yearmonth201109',
       'dac_yearmonth201110', 'dac_yearmonth201111', 'dac_yearmonth201112',
       'dac_yearmonth201201', 'dac_yearmonth201202', 'dac_yearmonth201203',
       'dac_yearmonth201204', 'dac_yearmonth201205', 'dac_yearmonth201206',
       'dac_yearmonth201207', 'dac_yearmonth201208', 'dac_yearmonth201209',
       'dac_yearmonth201210', 'dac_yearmonth201211', 'dac_yearmonth201212',
       'dac_yearmonth201301', 'dac_yearmonth201302', 'dac_yearmonth201303',
       'dac_yearmonth201304', 'dac_yearmonth201305', 'dac_yearmonth201306',
       'dac_yearmonth201307', 'dac_yearmonth201308', 'dac_yearmonth201309',
       'dac_yearmonth201310', 'dac_yearmonth201311', 'dac_yearmonth201312',
       'dac_yearmonth201401', 'dac_yearmonth201402', 'dac_yearmonth201403',
       'dac_yearmonth201404', 'dac_yearmonth201405', 'dac_yearmonth201406',
       'dac_yearmonth201407', 'dac_yearmonth201408', 'dac_yearmonth201409',
       'tfa_year2009', 'tfa_year2010', 'tfa_year2011', 'tfa_year2012',
       'tfa_year2013', 'tfa_year2014', 'tfa_month01', 'tfa_month02',
       'tfa_month03', 'tfa_month04', 'tfa_month05', 'tfa_month06',
       'tfa_month07', 'tfa_month08', 'tfa_month09', 'tfa_month10',
       'tfa_month11', 'tfa_month12', 'tfa_day01', 'tfa_day02', 'tfa_day03',
       'tfa_day04', 'tfa_day05', 'tfa_day06', 'tfa_day07', 'tfa_day08',
       'tfa_day09', 'tfa_day10', 'tfa_day11', 'tfa_day12', 'tfa_day13',
       'tfa_day14', 'tfa_day15', 'tfa_day16', 'tfa_day17', 'tfa_day18',
       'tfa_day19', 'tfa_day20', 'tfa_day21', 'tfa_day22', 'tfa_day23',
       'tfa_day24', 'tfa_day25', 'tfa_day26', 'tfa_day27', 'tfa_day28',
       'tfa_day29', 'tfa_day30', 'tfa_day31', 'tfa_yearmonth200903',
       'tfa_yearmonth200905', 'tfa_yearmonth200906', 'tfa_yearmonth200910',
       'tfa_yearmonth200912', 'tfa_yearmonth201001', 'tfa_yearmonth201002',
       'tfa_yearmonth201003', 'tfa_yearmonth201004', 'tfa_yearmonth201005',
       'tfa_yearmonth201006', 'tfa_yearmonth201007', 'tfa_yearmonth201008',
       'tfa_yearmonth201009', 'tfa_yearmonth201010', 'tfa_yearmonth201011',
       'tfa_yearmonth201012', 'tfa_yearmonth201101', 'tfa_yearmonth201102',
       'tfa_yearmonth201103', 'tfa_yearmonth201104', 'tfa_yearmonth201105',
       'tfa_yearmonth201106', 'tfa_yearmonth201107', 'tfa_yearmonth201108',
       'tfa_yearmonth201109', 'tfa_yearmonth201110', 'tfa_yearmonth201111',
       'tfa_yearmonth201112', 'tfa_yearmonth201201', 'tfa_yearmonth201202',
       'tfa_yearmonth201203', 'tfa_yearmonth201204', 'tfa_yearmonth201205',
       'tfa_yearmonth201206', 'tfa_yearmonth201207', 'tfa_yearmonth201208',
       'tfa_yearmonth201209', 'tfa_yearmonth201210', 'tfa_yearmonth201211',
       'tfa_yearmonth201212', 'tfa_yearmonth201301', 'tfa_yearmonth201302',
       'tfa_yearmonth201303', 'tfa_yearmonth201304', 'tfa_yearmonth201305',
       'tfa_yearmonth201306', 'tfa_yearmonth201307', 'tfa_yearmonth201308',
       'tfa_yearmonth201309', 'tfa_yearmonth201310', 'tfa_yearmonth201311',
       'tfa_yearmonth201312', 'tfa_yearmonth201401', 'tfa_yearmonth201402',
       'tfa_yearmonth201403', 'tfa_yearmonth201404', 'tfa_yearmonth201405',
       'tfa_yearmonth201406', 'tfa_yearmonth201407', 'tfa_yearmonth201408',
       'tfa_yearmonth201409', 'age-1', 'age100', 'age14', 'age15', 'age16',
       'age17', 'age18', 'age19', 'age20', 'age21', 'age22', 'age23',
       'age24', 'age25', 'age26', 'age27', 'age28', 'age29', 'age30',
       'age31', 'age32', 'age33', 'age34', 'age35', 'age36', 'age37',
       'age38', 'age39', 'age40', 'age41', 'age42', 'age43', 'age44',
       'age45', 'age46', 'age47', 'age48', 'age49', 'age50', 'age51',
       'age52', 'age53', 'age54', 'age55', 'age56', 'age57', 'age58',
       'age59', 'age60', 'age61', 'age62', 'age63', 'age64', 'age65',
       'age66', 'age67', 'age68', 'age69', 'age70', 'age71', 'age72',
       'age73', 'age74', 'age75', 'age76', 'age77', 'age78', 'age79',
       'age80', 'age81', 'age82', 'age83', 'age84', 'age85', 'age86',
       'age87', 'age88', 'age89', 'age90', 'age91', 'age92', 'age93',
       'age94', 'age95', 'age96', 'age97', 'age98', 'age99', 'ageNA',
       'age_bucket0-4', 'age_bucket100+', 'age_bucket15-19',
       'age_bucket20-24', 'age_bucket25-29', 'age_bucket30-34',
       'age_bucket35-39', 'age_bucket40-44', 'age_bucket45-49',
       'age_bucket5-9', 'age_bucket50-54', 'age_bucket55-59',
       'age_bucket60-64', 'age_bucket65-69', 'age_bucket70-74',
       'age_bucket75-79', 'age_bucket80-84', 'age_bucket85-89',
       'age_bucket90-94', 'age_bucket95-99', 'age_bucketNA']


users_sessions_cols_nodate = ['view_search_results', 'wishlist_content_update',
					       'similar_listings', 'change_trip_characteristics', 'p3',
					       'header_userpic', 'contact_host', 'message_post_x', '-unknown-_x',
					       'dashboard', 'create_user', 'confirm_email_link',
					       'user_profile_content_update', 'user_profile', 'pending', 'p5',
					       ...
					       'first_browserTheWorld Browser', 'first_browserUC Browser',
					       'first_browserwOSBrowser', 'first_browserYandex.Browser',
					       'age-1', 'age100', 'age14', 'age15', 'age16',
					       'age17', 'age18', 'age19', 'age20', 'age21', 'age22', 'age23',
					       'age24', 'age25', 'age26', 'age27', 'age28', 'age29', 'age30',
					       'age31', 'age32', 'age33', 'age34', 'age35', 'age36', 'age37',
					       'age38', 'age39', 'age40', 'age41', 'age42', 'age43', 'age44',
